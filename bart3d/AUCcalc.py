...
def cal_auc(args, positions,auc_file):
    tf_json = args.tffile
    ...
    if len(positions) == 0:
        sys.stderr.write('\nError! Input file might not with right format!\n')
        sys.exit(1)
    ...
    # auc_file = args.outdir+os.sep+args.outFileName + '_auc.txt'
    ...
    sys.stdout.write('== ROC-AUC calculation finished!\n== Results saved in file: {}\n'.format(auc_file))
